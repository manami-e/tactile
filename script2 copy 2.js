...
form.myFile.addEventListener('change', function (e) {
    ...
    reader.addEventListener('load', function () {
        ...
        var text2 = 0;
        var id_text = id_text1 + String(id_num) + id_text2;

        for (j = 0; j < num; j++) {
            // console.log(String(id_text[k]));
            if (f7[j].indexOf('M') !== -1) {
                ctmp = String(f7[j]) + ' ' + String(f7[j + 1] / reduce - trans_x) + ' ' + String(f7[j + 2] / reduce - trans_y);
                // console.log(String(ctmp));
                text2 = String(text2) + String(ctmp);
                // console.log(String(text2[k]));
                j += 3;
            }
            if (f7[j].indexOf('C') !== -1) {
                ctmp = String('L') + ' ' + String(f7[j + 5] / reduce - trans_x) + ' ' + String(f7[j + 6] / reduce - trans_y);
                // console.log(String(ctmp));
                text2 = String(text2) + ' ' + String(ctmp);
                // console.log(String(text2[k]));
                j += 6;
        ...
        var text3 = text + '\n' + String(id_text) + String(text2) + ' ' + String(id_text3) + '\n' + '</svg>';
