...
// const DRAW_AREA_WIDTH = 693;
// const DRAW_AREA_HEIGHT = 490;
...
const GUIDE_STROKE_COLOR_A4 = '#0000ff'; //線の色(A4)
...
$(window).on('load', function () {
  ...
  ******************************************************/
  ...
  function fileLoad_svg() {
    ...
    continue_setSVG(svg_text, -DRAW_AREA_WIDTH + 200, -DRAW_AREA_HEIGHT + 200, DRAW_AREA_WIDTH * 2.5, DRAW_AREA_HEIGHT * 2.5);
    cash_svg();
  }
